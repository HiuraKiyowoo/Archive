...
| `scrapers/animexin-scraper` | animexin.dev | donghua stream+download | zero-dep | 22 |
| `scrapers/cosmicscans-scraper` | 03.cosmicscans.to | manga/manhwa ID (API JSON) | zero-dep | 21 |
| `scrapers/okyykomik-scraper` | www.okyykomik.my.id | manga/manhwa ID (Blogger feed) | zero-dep | 21 |
