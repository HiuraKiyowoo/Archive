...
```bash
node scraper.js home                          # homepage
node scraper.js search "solo leveling"        # cari komik
node scraper.js search "swordmaster" 2        # cari + halaman 2
node scraper.js genre action                  # daftar komik per genre
node scraper.js genre romance 2               # genre + halaman 2
node scraper.js detail "https://komikindo.ch/komik/magic-emperor/"
node scraper.js chapter "https://komikindo.ch/magic-emperor-chapter-901/"
```
